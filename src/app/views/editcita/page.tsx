...
const Form: React.FC = () => {
  ...
  const handleSearch = () => {
    fetch('http://localhost:4000/cita/'+ searchTerm)
      .then(response => {
        if (!response.ok) {
  ...
  return (
    <div>  
      ...
      <div className="max-w-lg mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
        <h1 className="text-xl font-bold text-center text-gray-700 dark:text-gray-200 mb-8">Editar cita</h1>
          <div className="flex items-start flex-col justify-start mb-5">
